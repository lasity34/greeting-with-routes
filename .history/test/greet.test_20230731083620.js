...
const db = pgPromise()(process.env.TEST_DATABASE_URL);
...
describe('Greeting function', function() {
    ...
    it('This should return a greeting after the name is entered', async function() {
        ...
        console.log('Language has been set');
      
        const result = await greeting.greetMessage("bjorn");
        console.log('First greetMessage result:', result);
